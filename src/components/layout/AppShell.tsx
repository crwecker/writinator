...
export function AppShell() {
  ...
  return (
    <div className="flex flex-col h-screen w-screen bg-bg-darker text-gray-200 overflow-hidden">
      {/* Top bar */}
      <div className="flex items-center border-b border-gray-700 bg-bg-dark px-4 py-1.5 text-sm shrink-0 relative">
        <button
          ref={titleRef}
      ...
      {/* Bottom bar */}
      <div className="flex items-center justify-between border-t border-gray-700 bg-bg-dark px-4 py-1 text-xs shrink-0">
