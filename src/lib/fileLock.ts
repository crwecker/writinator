...
// Exception: browsers without the File System Access API (Safari, Firefox) can never
// persist a file handle. Locking those users would make the app unusable, so we treat
